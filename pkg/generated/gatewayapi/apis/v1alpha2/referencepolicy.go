...
func NewReferencePolicyInformer(client versioned.Interface, namespaces informers.NamespaceSet,
	resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
	return NewFilteredReferencePolicyInformer(client, namespaces, resyncPeriod, indexers, nil)
}

// NewFilteredReferencePolicyInformer constructs a new informer for ReferencePolicy type.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewFilteredReferencePolicyInformer(client versioned.Interface, namespaces informers.NamespaceSet,
...
func (f *referencePolicyInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewFilteredReferencePolicyInformer(client, f.namespaces, resyncPeriod,
