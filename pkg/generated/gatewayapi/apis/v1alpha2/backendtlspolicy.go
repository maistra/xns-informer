...
func NewBackendTLSPolicyInformer(client versioned.Interface, namespaces informers.NamespaceSet,
	resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
	return NewFilteredBackendTLSPolicyInformer(client, namespaces, resyncPeriod, indexers, nil)
}

// NewFilteredBackendTLSPolicyInformer constructs a new informer for BackendTLSPolicy type.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewFilteredBackendTLSPolicyInformer(client versioned.Interface, namespaces informers.NamespaceSet,
...
func (f *backendTLSPolicyInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewFilteredBackendTLSPolicyInformer(client, f.namespaces, resyncPeriod,
